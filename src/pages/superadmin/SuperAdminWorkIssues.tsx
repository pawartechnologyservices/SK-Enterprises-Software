            ...
            <div className="grid gap-4 md:grid-cols-4">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">Issues closed today</p>
                </CardContent>
              </Card>
            </div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <div className="font-medium">{typeCounts.task}</div>
                        <div className="text-xs text-muted-foreground">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <div className="font-medium">{typeCounts.service}</div>
                        <div className="text-xs text-muted-foreground">
                  ...
                  <TableBody>
                    {workQueries
                      ...
                      <TableRow key={query.id} className={
                        query.priority === "critical" ? "bg-red-50" : "bg-orange-50"
                      }>
